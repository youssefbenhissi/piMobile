...
import com.mycompany.myapp.services.TagService;
 ...
 * @author Alaa
 */
public class ArticleListByIdTag extends Form{
 EncodedImage enc;
 Date date;
 ArrayList<Articles> Articles;
    public ArticleListByIdTag(int id) {
      ...
      Articles = artser.GetArticlesTagID(id);
        Tags tag ;
        TagService tagSer = new TagService();
        tag = tagSer.GetTagById(id);
        System.out.println(tag.getNom() + " " +tag.getId());
        
       //this.setTitle(server.html2text(tag.getNom()));

...
public class CommentaireEvenementForm extends BaseForm {
    ...
    public CommentaireEvenementForm(Resources res, Evenement evenDetails) {
        ...
        Image afficheEvenement = UrlAffiche(evenDetails.getImageEvenement());
        ...
        carrouselContainer.addComponent(BorderLayout.NORTH, BoxLayout.encloseY(
                FlowLayout.encloseCenter(createForFont(largeBoldSystemFont, evenDetails.getNomEvenement()))
                ));
        ...
        // commentaire
        ArrayList<CommentaireEvenement> commentaires = evenementService.afficherCommentaire(String.valueOf(evenDetails.getIdEvenement()));
        ...
        commenterBouton.addActionListener((add) -> {
            CommentaireEvenement commentaire = new CommentaireEvenement(evenDetails.getIdEvenement(), SessionManager.getId(), "Ajoute par "+SessionManager.getUserName()+":\n"+commentaireTextField.getText());
            evenementService.ajouterCommentaire(commentaire);

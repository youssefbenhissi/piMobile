...
public class Service1 {
    ...
    public void Modifierprofile(Utilisateur u,String nouveauUsername) {
        String url = "http://127.0.0.1:8000/api/modifyProfile";
        ConnectionRequest request = new ConnectionRequest(url, false);
        try {
            request.addArgument("email", String.valueOf(u.getEmail()));
            request.addArgument("username",String.valueOf(u.getUsername()) );
            request.addArgument("Nouveauusername",nouveauUsername);
            request.addArgument("password",u.getPassword());
            request.addArgument("tel", String.valueOf(u.getTelephone()));

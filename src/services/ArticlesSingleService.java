...
public class ArticlesSingleService {
 ...
 public Articles GetArticleById(int id){
        ...
        String url =Statics.BASE_URL+"api/articles/"+id;
        req.setUrl(url);
        req.setPost(false);
 ...
 public void ArticleVueinc(int id){
        String url =Statics.BASE_URL+"api/articles/vueinc/"+id;
        req.setUrl(url);
        req.setPost(false);
    ...
    public String Parselike(String jsonArticles) throws IOException{
       ...
       List<Map<String,Object>> list = (List<Map<String,Object>>)likListJson.get("root");
         ...
         public String GetArticlesLike(int id,String email){
            ...
            String url = Statics.BASE_URL+"api/articles/likecheck/?"
                    + "id=" + id + "&email=" + email;
          req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
        ...
        String url = Statics.BASE_URL+"api/articles/likeadd/?"
                    + "id=" + id + "&email=" + email;
        req.setUrl(url);
        req.setPost(false);
        ...
        String url = Statics.BASE_URL+"api/articles/likeremo/?"
                    + "id=" + id + "&email=" + email;
        req.setUrl(url);
        req.setPost(false);
  ...
  public int GetArticlesLikescount(int id){
            ...
            String url = Statics.BASE_URL+"api/articles/Likes/"+id;
          req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
